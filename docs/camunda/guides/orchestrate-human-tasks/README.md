...
> What are the two most difficult problems in computer science? <br />
...
- **Processes and Pools**: Use an object and a nominalised verb to define the purpose of the whole process (e.g., Order 
  Fulfillment, Invoice Processing). Give the pool the same name as the process it contains.
- **Tasks and Subprocesses**: Use an active Verb + Noun phrase (e.g., Submit Application, Approve Request). For subprocesses,
