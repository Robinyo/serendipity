...
| Identity&nbsp;Service | <span style={{whiteSpace: 'nowrap'}}>https://serendipity-identity-service.localhost/admin</span> | Manage users, applications, roles, and groups. Access the Identity Service with `temp-admin / secret`. |
