...
http://localhost:8070/import/resources?source=https://raw.githubusercontent.com/Robinyo/serendipity/refs/heads/serendipity-4.0/backend/services/camunda/case-management/serendipity-forms.zip
```
