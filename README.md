...
- **Authentication (AuthN) & Authorization (AuthZ)** thanks to:
  ...
  - The [OIDC Auth](https://github.com/Robinyo/serendipity/tree/master/projects/auth-oidc) library which supports email/password registration and login (using Implicit Flow or Authorization Code Flow with PKCE)
