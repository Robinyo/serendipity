...
> **This workspace:** check for `src/tailwind.scss` first. Where it is absent, adding Tailwind v4 is
> an explicit setup decision to confirm with the user, not a prerequisite to assume.
